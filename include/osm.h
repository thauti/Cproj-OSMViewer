...
typedef struct way_s
{
	...
	node** nodes;
	int nodes_size;
	char type_way; // 0: inconnue 1: Building 2: Route/highway 3: Landuse(Jardin) 4: Leisure 5:waterway 6:Amenity 7:railway
	char type_val; 
	...
	//11: pedestrian 12: fountain 13: grass 14: tertiary
	char* nom;
	char sensUnique;
	char visible;
}way;
